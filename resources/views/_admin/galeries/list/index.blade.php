                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <span class="text-truncate-1-line">{{ $galery->id }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="hstack gap-3">
                                                        <div class="avatar-image ">
                                                            @if ($galery->image)
                                                                <a
                                                                    href="{{ route('admin.galery.view', ['galery' => $galery]) }}"><img
                                                                        src="{{ asset('img/galeries/' . $galery->image) }}"
                                                                        alt="galery Image" class="img-thumbnail"
                                                ...
                                                <td>
                                                    <div class="hstack gap-3">
                                                        <span class="text-truncate-1-line">{{ $galery->title }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div href="apps-mail.html">
                                                        {{ Str::limit($galery->description, 50, '...') }}</div>
                                                </td>
                                                <td>

...
@section('title', 'Sogecepa- Visualizar Universidade')
@section('content')
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Universidades</h5>
                </div>
                <ul class="breadcrumb">
            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="{{ route('admin.school.listar') }}" class="btn btn-danger">
                                    ...
                                    <div class="proposal-from">
                                        ...
                                        <div class="fs-13 text-muted lh-lg">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm">
                                                    <i class="feather-insschoolram"></i>
                                                </a>
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm">
                                ...
                                <div class="accordion proposal-faq-accordion" id="accordionFaqGroup">
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFaqGroup">
                                            <div class="accordion-body">Yes! Youc can change your package at any time. Upgrades will apply immediately to all your live and drafted events, so you can take advanschoole of professional product capabolities.</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
            ...
            <div class="tab-pane fade" id="tasksTab">
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-xl-6">
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body task-schools">
                                <div class="mb-4">
                                    <h5 class="card-title mb-1">schools</h5>
                                    <span class="fs-12 fw-normal text-muted d-block">schools label for tasks</span>
                                </div>
                                <select class="form-select form-control" data-select2-selector="school" multiple>
                    ...
                    <div class="card card-body general-info">
                        <div class="mb-4 d-flex align-items-center justify-content-between">
                            <h5 class="fw-bold mb-0">
                                ...
                                <span class="fs-12 fw-normal text-muted d-block">Sobre a Universidade</span>
                            </h5>
                            <a href="{{ route('admin.school.listar') }}" class="btn btn-sm btn-light-brand">Listar
                                Universidade</a>
                        </div>
                        <div class="row mb-4">
                        ...
                        {{-- Name of school --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Nome da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                        ...
                        {{-- Nº da Universidade --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Nº da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $school->nSchool }}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        {{-- Email of school --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Email da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                        ...
                        {{-- NIF --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">NIF da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $school->nif }}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        {{-- Phone of school --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Telefone da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                        ...
                        <div class="mb-4 d-flex align-items-center justify-content-between">
                            <h5 class="fw-bold mb-0">
                                <span class="d-block mb-2">Informação Da Universidade :</span>
                            </h5>
                        </div>

                        {{-- Tipo de Universidade --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Tipo da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                        ...
                        {{-- Quantidade de Salas --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Quantidade de Salas</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $school->nRoom }}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Nível da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Categoria da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $school->schoolCategory ?? 'N/A' }}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        {{-- <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Cursos na Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                @foreach ($school->courses as $course)
                                    <a href="javascript:void(0);" class="hstack gap-2">
                                        <span class="badge bg-light-primary text-primary">{{ $course->name }}</span>
                                    </a>
                                @endforeach
                            </div>
                        </div> --}}

                        {{-- Turno nas Universidade --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Turno da Universidade</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $school->bout }}</span>
                                </a>
                            </div>
                        </div>

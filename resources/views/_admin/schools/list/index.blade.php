...
@section('title', 'Assessorarte- Listar Univercidades')
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Univercidades</h5>
                </div>
                <ul class="breadcrumb">
            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="{{ route('admin.school.create') }}" class="btn btn-danger">
                            <i class="feather-plus me-2"></i>
                            <span>Nova Univercidade</span>
                        </a>
                    </div>
                </div>
                                ...
                                <table class="table table-hover" id="proposalList">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ID</th>
                                            <th>Nome</th>
                                            <th>Nº da Univercidade</th>
                                            <th>E-mail da Univercidade</th>
                                            <th>NIF da Univercidade</th>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a class="avatar-text avatar-md"
                                                            href="{{ route('admin.school.view', ['school' => $school]) }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.school.edit', ['school' => $school]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.school.destroy', ['school' => $school]) }}">

...
@section('title', 'Assessorarte- Visualizar Finalista')
@section('content')
                    ...
                    <div class="card card-body general-info">
                        <div class="mb-4 d-flex align-items-center justify-content-between">
                            <h5 class="fw-bold mb-0">
                                <span class="d-block mb-2">Sobre a Finalista :</span>
                                <span class="fs-12 fw-normal text-muted d-block">Sobre a Finalista</span>
                            </h5>
                        ...
                        {{-- Name of school --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Nome do Finalista</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                        ...
                        {{-- Email of school --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Email do Finalista</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $finalist->email }}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        {{-- Phone of school --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">Telefone do Finalista</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $finalist->phone }}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        {{-- BI --}}
                        <div class="row mb-4">
                            <div class="col-lg-2 fw-medium">BI do Finalista</div>
                            <div class="col-lg-10 hstack gap-1">
                                <a href="javascript:void(0);" class="hstack gap-2">
                                    <span>{{ $finalist->bi }}</span>
                                </a>
                            </div>
                        </div>

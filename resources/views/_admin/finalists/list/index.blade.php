...
@section('title', 'Sigecepa- Finalistas')
@section('content')
            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="{{ route('admin.finalist.create') }}" class="btn btn-danger">
                            <i class="feather-plus me-2"></i>
                            <span>Novo Finalistas</span>
                        </a>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        @foreach ($finalists as $finalist)
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <div class="hstack gap-2">
                                                        ...
                                                        <div class="avatar-image avatar-md">
                                                            @if ($finalist->cover)
                                                                <a href="{{ asset('img/finalist/' . $finalist->cover) }}"><img
                                                                        src="{{ asset('img/finalist/' . $finalist->cover) }}"
                                                                        alt="finalist Image" class="img-thumbnail"
                                                ...
                                                <td>{{ $finalist->name }}</td>
                                                <td>{{ $finalist->email }}</td>
                                                <td>{{ $finalist->phone }}</td>
                                                <td>{{ $finalist->bi }}</td>
                                                <td>{{ $finalist->course->name ?? 'N/A' }}</td>
                                                <td>{{ $finalist->school->name ?? 'N/A' }}</td>

                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a href="{{ route('admin.finalist.view', ['finalist' => $finalist]) }}"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.finalist.edit', ['finalist' => $finalist]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.finalist.delete', ['finalist' => $finalist]) }}">

...
@section('title', 'Assessorarte- Listar Cursos')
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a class="avatar-text avatar-md"
                                                            href="{{ route('admin.course.view', ['course' => $course]) }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.course.edit', ['course' => $course]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.course.destroy', ['course' => $course]) }}">
